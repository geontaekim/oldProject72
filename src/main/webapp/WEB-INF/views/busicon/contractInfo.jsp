...
<div class="modal fade" id="amountModal" role="dialog">
  ...
  //수주      
        ...
        const searchByDateRadio = document.querySelector("#searchByDateRadio");     // 기간검색
...
//-------------------------------------수주조회 버튼--------------------------------------------//
     contractSearchBtn.addEventListener("click", () => {
            ...
            let dateApply = isChecked ? "searchByDate" : searchByCustomerRadio.value;
            customerCode = searchCustomerBox.value;
            console.log("customerCode??"+customerCode);
            contractInfoGridOptions.api.setRowData([]);
            console.log("searchByCustomerRadio.value??"+searchByCustomerRadio.value);
            let xhr = new XMLHttpRequest();
            xhr.open('POST','${pageContext.request.contextPath}/busicon/searchContractList.do?'
      ...
      //-------------------------------------수주상세 조회--------------------------------------------//        
        ...
        contractDetaillBtn.addEventListener("click", () => {
           let selectedNodes = contractInfoGridOptions.api.getSelectedNodes();
            ...
            let xhr = new XMLHttpRequest();
            xhr.open('POST', '${pageContext.request.contextPath}/busicon/searchContractDetail.do' +
 ...
 //-----------------------------------------PDF 출력 저장버튼------------------------------------//      
        ...
        pdfOpenBtn.addEventListener("click", () => {
           ...
           window.open("${pageContext.request.contextPath}/logiinfo/report.html?method=contractReport&orderDraftNo=" + getRowIdValue,"window", "width=1600, height=1000" );
        });
