...
//  ======================일괄저장======================================================================
  // 일괄저장 <= 선택된 항목만 저장
  batchSaveButton.addEventListener("click", () => {  //일괄저장에 걸려있는  id이름에 걸린 이벤트 처리 !
   ...
   //console.log(estGridOptions.getSelectedRowData())
    ...
    Swal.fire({
      ...
      xhr.open('POST', "${pageContext.request.contextPath}/busi/addNewEstimate.do?method=addNewEstimate&estimateDate="// 위의 값들을 addNewEstimate.do를 호출시켜서 던질거임
