...
<script>
   ...
   function getEmployeeData(){
        ...
        xhr.open('POST', '${pageContext.request.contextPath}/hr/getEmployeeList.do' +
   ...
   function getUserAuthorityGroupData(){
      ...
      console.log(empCode);
        let xhr = new XMLHttpRequest();
        xhr.open('POST', '${pageContext.request.contextPath}/hr/getUserAuthorityGroup.do' +
     ...
     saveButton.addEventListener("click", () => {
           Swal.fire({
               ...
               // console.log(insertData);
                   ...
                   let xhr = new XMLHttpRequest();
                 xhr.open('POST', '${pageContext.request.contextPath}/hr/insertEmployeeAuthorityGroup.do' +
