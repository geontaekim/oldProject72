...
<script>
   ...
   function getAuthorityGroupData(){
        ...
        xhr.open('POST', '${pageContext.request.contextPath}/hr/getAuthorityGroup.do' +
   ...
   function getMenuAuthorityData(){
      ...
      console.log(authorityGroupCode);
        let xhr = new XMLHttpRequest();
        xhr.open('POST', '${pageContext.request.contextPath}/hr/getMenuAuthority.do' +
     ...
     saveButton.addEventListener("click", () => {
           ...
           Swal.fire({
               ...
               console.log(insertData);
                    ...
                    let xhr = new XMLHttpRequest();
                 xhr.open('POST', '${pageContext.request.contextPath}/hr/insertMenuAuthority.do' +
