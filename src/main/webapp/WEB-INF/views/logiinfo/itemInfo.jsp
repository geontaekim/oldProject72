...
<script>
  ...
  const iteminquiryinformation = (itemGroupCode) => {
    ...
    xhr.open('POST', "${pageContext.request.contextPath}/logiinfo/searchitemGroupList.do"
  ...
  const deleteitemgroup = (selectedRow) => {
       ...
       xhr.open('POST', "${pageContext.request.contextPath}/logiinfo/deleteitemgroup.do"
 ...
 /*    getRowNodeId: function(data) {
  ...
  const deliverableContract = (selectedRow) => {
   ...
   deliverableContractGridOptions.api.setRowData([]);
    ...
    let xhr = new XMLHttpRequest();
    xhr.open('POST', "${pageContext.request.contextPath}/logiinfo/searchitemInfoList.do"
  ...
  batchSaveButton.addEventListener("click", () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
         ...
         let xhr = new XMLHttpRequest();
           xhr.open('POST', "${pageContext.request.contextPath}/logiinfo/batchSave.do"
               + "?method=batchSave"
               + "&ableContractInfo=" + ableContractInfo,
               true);
