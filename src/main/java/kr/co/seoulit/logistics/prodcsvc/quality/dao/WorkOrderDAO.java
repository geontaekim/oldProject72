package kr.co.seoulit.logistics.prodcsvc.quality.dao;
...
public interface WorkOrderDAO {
	...
	public void workOrder(HashMap<String, Object> map);
	...
	public void workSiteLogList(HashMap<String, String> map);
